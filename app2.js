...
if (!Array.isArray(list)) {
    ...
    //   if (this.artistname.indexOf(list) != -1) {
...
//giphy function/////////////////////////////////////////////////////////////////////////
        ...
        var queryURL = "https://www.googleapis.com/customsearch/v1?key=AIzaSyD6hRCsxasLHuI6z9B2xNH0QvNv2qEqSwA&cx=002776073657899069731:mgecnh_lsxw&q=photo&fileType=png,jpg&searchType=image&num=10&alt=json" + artistGiph;
        $.ajax({
          url: queryURL,
          dataType: 'jsonp',
          method: "GET"
